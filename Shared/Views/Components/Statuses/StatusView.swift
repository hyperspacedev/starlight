    ...
    private struct content: View {
        ...
        var body: some View {
            ...
            return VStack(alignment: .leading) {
                ...
                RenderedText(
                    text: self.content.stripHTML(),
                    fontSize: self.isMain ? 20 : 16,
                    negativePadding: isMain ? 30 : 90
                )
...
extension StatusView.view {
    ...
    /**
     ...
     - Parameters:
         ...
         - status: The identified data that the ``StatusView`` instance uses to display posts dynamically.
    */
    ...
    static var previews: some View {
        VStack {
            if self.timeline.statuses.isEmpty {
                ...
                StatusView.view(
                    StatusConfiguration.DisplayMode.compact,
                    status: self.timeline.statuses[0]
                )
            }
        }
